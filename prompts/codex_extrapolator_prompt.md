...
Convert a Codex CLI task transcript into a `BehavioralWindow` that preserves the EDAMAME `SessionPrediction` schema:
...
1. Codex CLI is the reasoning plane only. Do not invent observed system facts.
